...
if (isset($_POST['search'])) {
    $search = $_POST['search'];
    $search_query = "SELECT COUNT(*) AS total FROM bookings WHERE nama LIKE '%$search%' OR kode_booking LIKE '%$search%'";
...
$status_query = "SELECT status, COUNT(*) AS total FROM bookings GROUP BY status";
